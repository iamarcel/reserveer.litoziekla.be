...
import { Campaign } from './reservations/models/campaign';
import { Pricebook2 } from './reservations/models/pricebook2';
import { Product2 } from './reservations/models/product2';
import { RecordType } from './reservations/models/record-type';
